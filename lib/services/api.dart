...
import 'package:prefinal/models/api_result.dart';
...
class Api {
  ...
  Future<dynamic> submit(
    ...
    final response = await http.post(
      url,
      headers: {'Content-Type': 'application/json', 'id':'620710127'},
  ...
  Future<dynamic> fetch(
    ...
    final response = await http.get(url,headers: {'id':'620710127'});
